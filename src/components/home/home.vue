<template>
  <div class="border rounded p-2 ">
    <div class="mx-8 flex items-center justify-center text-white bg-[#f5f3f7]">
      <div class="flex flex-col mr-10 mt-4">
    ...
    <div class="mx-8 mt-1 fmontserrat text-[#48096d] text-xl font-bold">
      Home
    </div>
