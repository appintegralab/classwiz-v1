        ...
        <q-dialog v-model="dialog" persistent>
            <div class="md:min-w-[600px] lg:min-w-[800px] overflow-hidden rounded bg-white card-shadow">
                <div class="grid grid-cols-2">
                    ...
                    <div class="bg-[#d5dfee] col-span-2 sm:col-span-1 p-4">
                        <div class="mx-8 flex items-center justify-around text-white">
                            <div class="flex flex-col">
                                <div class="flex justify-center">
                                    <div class="w-[100px]">
                                        <img src="@/assets/logo-quad.png" alt="">
                                    </div>
                                </div>
                            </div>
                            
                        </div>
                        <div class="mt-4 text-center fmontserrat text-purple-900 text-sm font-bold">
                            Bem-vindo!
                        </div>
                        <div class="mt-1 mx-2 text-center fmontserrat text-purple-900 text-[9pt] font-light">
                        ...
                        <div class="mt-4 flex justify-center text-purple-900">
                            <button @click="$refs.dialoguserref.show()"
                                class="hover:bg-blue-100 border border-purple-900 px-3 text-sm  rounded-lg py-[2px]">
